...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="navbar nav-first navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link text-primary" href="#home">Llama al:<span class="pl-3 text-muted">55 4436 8595</span></a>
                </li>
            </ul>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 order-1 order-sm-first">
                    <div class="row">
                        ...
                        <img alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, Pigga Landing page" src="assets/imgs/1663113859889.jpeg" class="w-100 rounded shadow">
    ...
    <!-- Service Section -->
    <header class="header">
        <section id="precios" class="overlay ">
            <div class="container">
            ...
            <div class="row align-items-center text-center text-md-right">
                <div class="col">
                    <p class="mb-0 small">&copy; <script>
                        ...
                        </script>, <a target="_blank">Oscar & Sebastian</a> Todos los derechos reservados </p>
                </div>
            </div>
        </div>
